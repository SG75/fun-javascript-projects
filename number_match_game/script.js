...
//arrow function for timer
const timeDealy = 3000
...
document.getElementById("timeSetting").innerHTML = timeDealy / 1000;
...
const timer = () => {
    setInterval(generate, timeDealy);
};
...
const endOfGame = () => {
    ...
    setTimeout(() => location.reload(), timeDealy);
};
